    ...
    <>
      ...
      <header className="top">
        <div className="wrap nav">
          ...
          <div className="navright"><button className="iconbtn" aria-label="Cari event dan cerita" onClick={() => setModal({ type: 'search' })}><Search /></button><a className="btn light desktop" href="/login">Masuk</a><a className="btn" href="/join">Join Ngahiji <span>↗</span></a></div>
        </div>
      </header>
      <main id="main">
        ...
        <section className="wrap closing" id="join"><div className="eyebrow">Your next chapter starts here</div><h2>LET'S NGAHIJI.</h2><p>Temukan event, cerita dan orang-orang yang membuat perjalananmu lebih berarti.</p><a className="btn" href="/join">JOIN NGAHIJI <span>↗</span></a></section>
      </main>
      ...
      <nav className="dock" aria-label="Navigasi seluler"><a className="active" href="#home"><Home />Home</a><a href="#events"><CalendarDays />Events</a><a href="#live"><Play />Live</a><a href="#media"><Newspaper />Media</a><a href="/profile"><UserRound />Profile</a></nav>
