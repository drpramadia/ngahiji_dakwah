  ...
  return (
    <form className="admin-form" action={action}>
      ...
      <div className="admin-form-grid">
        ...
        <label>Image URL<input name="image_url" type="url" required defaultValue={item?.image_url ?? ''} /></label>
      </div>
      ...
      <p className="notice">Media masih memakai URL gambar sampai storage/media asset migration aktif. Jangan pakai URL rahasia atau asset private.</p>
