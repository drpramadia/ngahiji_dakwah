...
export const demoEvents: EventRecord[] = [
  {
    ...
    image_url: ngahijiAssets.eventYouthKajian.publicPath
  },
  {
    ...
    image_url: ngahijiAssets.eventFamilyLearning.publicPath
  },
  {
    ...
    image_url: ngahijiAssets.eventEntrepreneurForum.publicPath
  }
];
...
export const demoStories: StoryRecord[] = [
  { slug: 'ruang-bertumbuh-anak-muda', title: 'Kenapa Anak Muda Butuh Ruang untuk Bertumbuh Bersama?', category: 'Kajian', format: 'ARTICLE', published_at: '2026-09-10T02:00:00.000Z', reading_time: '5 menit baca', image_url: ngahijiAssets.storyQuranStudy.publicPath, excerpt: 'Bertumbuh tidak selalu berarti punya semua jawaban.', body: 'Bertumbuh tidak selalu berarti punya semua jawaban. Kadang, langkah pertamanya adalah menemukan ruang aman untuk bertanya.', status: 'PUBLISHED' },
  { slug: 'ngahiji-gerakan-bersama', title: 'Ngahiji: Lebih dari Sekadar Event, Tapi Gerakan Bersama', category: 'Community', format: 'VIDEO', published_at: '2026-09-08T02:00:00.000Z', reading_time: '4 menit', image_url: ngahijiAssets.storyCommunityDiscussion.publicPath, excerpt: 'Pertemuan yang bermakna bisa menjadi awal perjalanan baru.', body: 'Sebuah acara selesai ketika lampu panggung padam. Tapi pertemuan yang bermakna bisa menjadi awal perjalanan baru.', status: 'PUBLISHED' },
  { slug: 'ketenangan-dalam-kesibukan', title: 'Menemukan Ketenangan dalam Kesibukan', category: 'Lifestyle', format: 'PODCAST', published_at: '2026-09-05T02:00:00.000Z', reading_time: '32 menit', image_url: ngahijiAssets.storyFamilyLearning.publicPath, excerpt: 'Memberi ruang untuk refleksi membantu kita kembali hadir.', body: 'Tidak setiap jeda perlu diisi. Memberi ruang untuk refleksi membantu kita kembali hadir.', status: 'PUBLISHED' },
  { slug: 'hal-kecil-berdampak-bersama', title: 'Mulai dari Hal Kecil, Berdampak Bersama', category: 'Youth', format: 'SHORT_STORY', published_at: '2026-09-03T02:00:00.000Z', reading_time: '3 menit baca', image_url: ngahijiAssets.storyVolunteerImpact.publicPath, excerpt: 'Kebaikan tidak harus menunggu rencana besar.', body: 'Kebaikan tidak harus menunggu rencana besar. Langkah kecil bisa dimulai hari ini.', status: 'PUBLISHED' }
];
