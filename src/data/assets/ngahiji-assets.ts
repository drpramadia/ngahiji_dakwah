...
export const ngahijiAssets = {
  ...
  eventFamilyLearning: {
    id: 'event-family-learning', filename: 'event-family-learning.svg', title: 'Family Learning Event', description: 'Acara pembelajaran keluarga Muslim yang hangat.', category: 'FAMILY', section: 'EVENTS', altText: 'Acara pembelajaran keluarga Muslim', aspectRatio: '4:3', width: 1200, height: 900, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/events/event-family-learning.svg'
  },
  eventEntrepreneurForum: {
    id: 'event-entrepreneur-forum', filename: 'event-entrepreneur-forum.svg', title: 'Muslim Entrepreneur Forum', description: 'Forum wirausaha Muslim dan diskusi komunitas.', category: 'ENTREPRENEUR', section: 'EVENTS', altText: 'Forum wirausaha Muslim dan diskusi komunitas', aspectRatio: '4:3', width: 1200, height: 900, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/events/event-entrepreneur-forum.svg'
  },
  liveKajianStage: {
    id: 'live-kajian-stage', filename: 'live-kajian-stage.svg', title: 'Ngahiji Live Kajian Stage', description: 'Panggung kajian profesional untuk konten live.', category: 'LIVE', section: 'LIVE', altText: 'Panggung kajian profesional untuk Ngahiji Live', aspectRatio: '16:9', width: 1280, height: 720, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/live/live-kajian-stage.svg'
  },
  storyQuranStudy: {
    id: 'story-quran-study', filename: 'story-quran-study.svg', title: 'Quran Study Story', description: 'Visual belajar Al Quran dan kajian.', category: 'KAJIAN', section: 'MEDIA', altText: 'Visual belajar Al Quran dan kajian Islam', aspectRatio: '9:7', width: 900, height: 700, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/media/story-quran-study.svg'
  },
  storyCommunityDiscussion: {
    id: 'story-community-discussion', filename: 'story-community-discussion.svg', title: 'Community Discussion Story', description: 'Diskusi Muslim muda dalam lingkar komunitas.', category: 'COMMUNITY', section: 'MEDIA', altText: 'Diskusi komunitas Muslim muda', aspectRatio: '9:7', width: 900, height: 700, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/media/story-community-discussion.svg'
  },
  storyFamilyLearning: {
    id: 'story-family-learning', filename: 'story-family-learning.svg', title: 'Family Learning Story', description: 'Pembelajaran keluarga Muslim.', category: 'FAMILY', section: 'MEDIA', altText: 'Keluarga Muslim belajar bersama', aspectRatio: '9:7', width: 900, height: 700, source: 'LOCAL_PUBLIC', status: 'PUBLISHED', publicPath: '/assets/ngahiji/media/story-family-learning.svg'
  },
